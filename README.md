...
Versión 0.3.1 - 17/03/2015
* Correcciones de varios errores menores
* Optimizaciones varias en la generación de la web
* Varias mejoras en la visualización de la web
* Cambios en la carga de las capas
* Cambios en la definición de los símbolos a usar en el mapa
* Cambios en la definición de las capas a usar en el mapa
* Añadidas nuevas capas
* Correción en la visualización de la leyenda/selector de capas

Versión 0.3.2 - 18/03/2015
* Reposicionamiento del cuadro de búsqueda en la zona del mapa.
* Mejoras en la presentación del cuadro de búsqueda.
* Nuevo estilo del cuadro de búsqueda.

Versión 0.3.3 - 20/03/2015
* Reposicionamiento del cuadro de búsqueda en la zona del mapa.
* Mejoras en la presentación del cuadro de búsqueda.
* Nuevo estilo del cuadro de búsqueda.
* Añadida funcionalidad auxiliar en javascript al cuadro de búsqueda.
* Cambios internos para manejar la búsqueda de los elementos.

Versión 0.3.4 - 25/03/2015
* Mejoras en la presentación del cuadro de búsqueda.
* Ampiada funcionalidad auxiliar en javascript al cuadro de búsqueda.
* Añadida funcionalidad de autocompletar al ir escribiendo en el cuadro de búsqueda.
* Cambios internos para manejar la búsqueda de los elementos.

Versión 0.3.5 - 07/04/2015
* Correción de error por el que se podían solapar varias búsquedas.
